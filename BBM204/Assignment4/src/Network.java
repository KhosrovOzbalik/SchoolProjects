...
public class Network implements Serializable {
    ...
    public Network(String filename) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (line.charAt(0) == 'R') routers.add(new Router(line.split(":")[1], this));
            else if (line.charAt(0) == 'L') {
                String[] attributes = line.replaceAll("Link:", "").replaceAll("Bandwidth:", "").replaceAll(" Mbps", "").split(" ");
                links.add(new Link(attributes[0].split("-")[0], attributes[0].split("-")[1], Integer.parseInt(attributes[1])));
            }
        }
